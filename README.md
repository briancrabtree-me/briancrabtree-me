...
**Senior web architect** — vanilla-first React, plain CSS, PageSpeed-minded delivery.
...
I build and repair web systems where speed and clarity matter: semantic HTML, vanilla CSS, lean JavaScript, and deploy paths you can audit. Performance is a product requirement, not a late pass.
...
- [react-pubsub-store](https://github.com/briancrabtree-me/react-pubsub-store) — pub/sub external store for React 19 (`useSyncExternalStore`)
- [snippet-library](https://github.com/briancrabtree-me/snippet-library) — copy-paste CSS, JS, HTML, and React snippets (themeable)
- [pure-react-19-vanilla-starter](https://github.com/briancrabtree-me/pure-react-19-vanilla-starter) — Vite + React 19 demo, prerender shell, CSS before module JS
- [vanilla-css-tokens](https://github.com/briancrabtree-me/vanilla-css-tokens) — acid-on-dark tokens and optional UI layout primitives
